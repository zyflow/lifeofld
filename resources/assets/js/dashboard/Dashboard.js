				...
				<div className="right-content">
					...
					<div className="main-container">
						...
						<div className="filters">
							...
							<button className={self.state.activeFilter === "projekter" ? "active" : null}
							        onClick={self.switchFilter.bind(self, "projekter")}>{trans('dashboard', 'project')}</button>
							<button className={self.state.activeFilter === "hjælpemidler" ? "active" : null}
							        onClick={self.switchFilter.bind(self, "hjælpemidler")}>{trans('dashboard', 'tools')}</button>
							<button className={self.state.activeFilter === "suppliers" ? "active" : null}
							        onClick={self.switchFilter.bind(self, "suppliers")}>{trans('dashboard', 'suppliers')}</button>
							<button className={self.state.activeFilter === "bi" ? "active" : null}
							        onClick={self.switchFilter.bind(self, "bi")}>{trans('dashboard', 'bi')}</button>
						</div>
						<DashboardCounters/>
